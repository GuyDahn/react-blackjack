...
const cardsObjects = {
    ...
    threeDiamonds: new Card('03d', cardImages.threeDiamonds, 3, 'Three of Diamonds'),
    ...
    sevenDiamonds: new Card('07d', cardImages.sevenDiamonds, 7, 'Seven of Diamonds'),
    ...
    eightDiamonds: new Card('08d', cardImages.eightDiamonds, 8, 'Eight of Diamonds'),
    ...
    tenClubs: new Card('10c', cardImages.tenClubs, 10, 'Ten of Clubs'),
    tenDiamonds: new Card('10d', cardImages.tenDiamonds, 10, 'Ten of Diamonds'),
    tenHearts: new Card('10h', cardImages.tenHearts, 10, 'Ten of Hearts'),
    tenSpades: new Card('10s', cardImages.tenSpades, 10, 'Ten of Spades'),

    // Jacks
    jackClubs: new Card('11c', cardImages.jackClubs, 11, 'Jack of Clubs'),
    jackDiamonds: new Card('11d', cardImages.jackDiamonds, 11, 'Jack of Diamonds'),
    jackHearts: new Card('11h', cardImages.jackHearts, 11, 'Jack of Hearts'),
    jackSpades: new Card('11s', cardImages.jackSpades, 11, 'Jack of Spades'),

    // Queens
    queenClubs: new Card('12c', cardImages.queenClubs, 12, 'Queen of Clubs'),
    queenDiamonds: new Card('12d', cardImages.queenDiamonds, 12, 'Queen of Diamonds'),
    queenHearts: new Card('12h', cardImages.queenHearts, 12, 'Queen of Hearts'),
    queenSpades: new Card('12s', cardImages.queenSpades, 12, 'Queen of Spades'),

    // Kings
    kingClubs: new Card('13c', cardImages.kingClubs, 13, 'King of Clubs'),
    kingDiamonds: new Card('13d', cardImages.kingDiamonds, 13, 'King of Diamonds'),
    kingHearts: new Card('13h', cardImages.kingHearts, 13, 'King of Hearts'),
    kingSpades: new Card('13s', cardImages.kingSpades, 13, 'King of Spades')
}
